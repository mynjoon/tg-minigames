...
const MODEL_COLORS = {
  ...
  "Galaxy Z Fold7": ["블루 섀도", "실버 섀도", "제트블랙"],
  "Galaxy Z Flip7": ["블루 섀도", "코랄 레드", "제트블랙"],
  "삼성 스타일 폴더2": ["블랙"],
                ...
                <div className="form-row three" style={{ marginTop: 8 }}>
                  <select className="select"
                    ...
                    <optgroup label="Galaxy Z">
                      <option>Galaxy Z Fold7</option>
                      <option>Galaxy Z Flip7</option>
                    </optgroup>
...
동네 프리미엄 상담 매장.
          ...
          <div>
            ...
            <ul className="footer-list">
              ...
              <li><a href="plans.html">요금제 전체보기</a></li>
              <li><a href="finder.html">요금제 찾기</a></li>

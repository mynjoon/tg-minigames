...
const DEVICES = [
  ...
  { id: 'ip17-pro-max', brand: 'apple', name: '아이폰 17 프로 맥스', series: '아이폰 프로', year: 2025, network: '5G',
    ...
    monthly: { min: 85000, max: 140000 }, unlocked: { min: 1900000, max: 2400000 }, img: 'assets/iphone-17-pro-max.webp' },
  { id: 'ip17-pro', brand: 'apple', name: '아이폰 17 프로', series: '아이폰 프로', year: 2025, network: '5G',
    ...
    monthly: { min: 78000, max: 130000 }, unlocked: { min: 1700000, max: 2100000 }, img: 'assets/iphone-17-pro.webp' },
  { id: 'ip17', brand: 'apple', name: '아이폰 17', series: '아이폰', year: 2025, network: '5G',
    ...
    monthly: { min: 62000, max: 108000 }, unlocked: { min: 1250000, max: 1550000 }, img: 'assets/iphone-17.webp' },
  { id: 'ip-air', brand: 'apple', name: '아이폰 에어', series: '아이폰', year: 2025, network: '5G',
    ...
    monthly: { min: 70000, max: 118000 }, unlocked: { min: 1500000, max: 1850000 }, img: 'assets/iphone-air.webp' },
  { id: 'ip17e', brand: 'apple', name: '아이폰 17e', series: '아이폰', year: 2026, network: '5G',
    ...
    monthly: { min: 45000, max: 82000 }, unlocked: { min: 850000, max: 1050000 }, img: 'assets/iphone-17e.webp' },
  // ── 삼성 플래그십 ──
  { id: 's26-ultra', brand: 'samsung', name: '갤럭시 S26 울트라', series: '갤럭시 S', year: 2026, network: '5G',
    storages: ['256GB', '512GB', '1TB'], channels: ['carrier', 'unlocked', 'used'], tags: ['flagship', 'popular', 'camera'],
    monthly: { min: 80000, max: 135000 }, unlocked: { min: 1700000, max: 2100000 }, img: 'assets/galaxy-s26-ultra.webp' },
  { id: 's26-plus', brand: 'samsung', name: '갤럭시 S26+', series: '갤럭시 S', year: 2026, network: '5G',
    ...
    monthly: { min: 70000, max: 118000 }, unlocked: { min: 1400000, max: 1700000 }, img: 'assets/galaxy-s26-plus.webp' },
  { id: 's26', brand: 'samsung', name: '갤럭시 S26', series: '갤럭시 S', year: 2026, network: '5G',
    storages: ['256GB', '512GB'], channels: ['carrier', 'unlocked', 'used'], tags: ['flagship', 'popular', 'compact'],
    monthly: { min: 60000, max: 105000 }, unlocked: { min: 1150000, max: 1400000 }, img: 'assets/galaxy-s26.webp' },
  { id: 'zfold8-ultra', brand: 'samsung', name: '갤럭시 폴드8 울트라', series: '갤럭시 Z', year: 2026, network: '5G',
    ...
    monthly: { min: 95000, max: 158000 }, unlocked: { min: 2577300, max: 2830300 }, img: 'assets/galaxy-fold8-ultra-violet.webp' },
  { id: 'zfold8', brand: 'samsung', name: '갤럭시 폴드8', series: '갤럭시 Z', year: 2026, network: '5G',
    ...
    monthly: { min: 90000, max: 148000 }, unlocked: { min: 2278100, max: 2531100 }, img: 'assets/galaxy-fold8-lavender.webp' },
  { id: 'zflip8', brand: 'samsung', name: '갤럭시 플립8', series: '갤럭시 Z', year: 2026, network: '5G',
    ...
    monthly: { min: 65000, max: 112000 }, unlocked: { min: 1683000, max: 1936000 }, img: 'assets/galaxy-flip8-graphite.webp' },
  // ── 실속 · 효도폰 ──
  { id: 'a17', brand: 'samsung', name: '갤럭시 A17', series: '갤럭시 A', year: 2025, network: '5G',
    ...
    monthly: { min: 25000, max: 50000 }, unlocked: { min: 280000, max: 380000 }, img: 'assets/galaxy-a17.webp' },
  { id: 'style-folder2', brand: 'samsung', name: '갤럭시 스타일 폴더2', series: '폴더폰', year: 2025, network: 'LTE',
    ...
    monthly: { min: 18000, max: 38000 }, unlocked: null, img: 'assets/galaxy-style-folder2.webp' },
  { id: 'senior-phone', brand: 'samsung', name: '효도폰 (버튼형·빅폰트)', series: '효도폰', year: 2024, network: 'LTE',
    ...
    monthly: { min: 12000, max: 30000 }, unlocked: null, img: 'assets/senior-phone.webp' },
];
